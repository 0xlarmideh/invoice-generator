...
export const basicSchema = yup.object().shape({
  recipientEmail: yup.string().email("Please enter a valid email"). required("Required"),
  recipientName: yup.string().required("Required"),
  clientName: yup.string().required("Required"),
  issuedOn: yup.date().max(new Date(), {message: "Due Date can't be higher than today's date"}).required(),
